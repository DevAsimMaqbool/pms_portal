...
<div data-i18n="Home">Home</div>
    ...
    @if(in_array(getRoleName(activeRole()), ['Teacher', 'Assistant Professor', 'Professor', 'Associate Professor', 'Program Leader UG', 'Program Leader PG', 'Demonstrator']))
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                @if(getRoleIdByName(activeRole()) == 33)
                  <li class="menu-item {{ request()->routeIs('/demo_user_report/' . Auth::user()->id) ? 'active' : '' }}">
                    <a href="{{ url('/demo_user_report/' . Auth::user()->id) }}" target="_blank" class="menu-link"
