      ...
      <div class="col-md-6 col-lg-4">
        ...
        <div class="scrollableCol" style="height:409px; overflow:auto; scrollbar-width: none;">
          ...
          @php
            ...
            $EmployabilityPercentage = getRatingByPercentage($EmployabilitydeanHotIndicators['avg'] ?? 0);
           @endphp
          <div class="card mb-6 scgrool-card-h hover-card" data-bs-toggle="tooltip" data-bs-placement="right"
            data-bs-custom-class="tooltip-{{ $EmployabilitydeanHotIndicators['color'] ?? 0 }}"
            data-bs-original-title="{{ $EmployabilityPercentage['description'] ?? 0 }}">
            <div class="card-body d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <div class="badge bg-label-{{ $EmployabilitydeanHotIndicators['color'] ?? 0 }} rounded p-1_5 me-4"><i
              ...
              <div class="d-flex flex-grow-1 align-items-center">
                <div class="progress w-100 me-4" style="height:8px;">
                  <div class="progress-bar bg-{{ $EmployabilitydeanHotIndicators['color'] ?? 0 }}" role="progressbar"
                    style="width:{{ $EmployabilitydeanHotIndicators['avg'] ?? 0 }}%" aria-valuenow="65" aria-valuemin="0"
                    aria-valuemax="100"></div>
                </div>
                <span class="text-body-secondary">{{ $EmployabilitydeanHotIndicators['avg'] ?? 0 }}%</span>
                <span
                  class="badge bg-label-{{ $EmployabilitydeanHotIndicators['color'] ?? 0 }} ms-1">{{ $EmployabilitydeanHotIndicators['rating'] ?? 0 }}</span>
              </div>
            </div>
          </div>
          ...
          @php
            ...
            $ResearchPublicationsPercentage = getRatingByPercentage($ResearchPublicationssdeanHotIndicators['avg'] ?? 0);
           @endphp
          <div class="card mb-6 scgrool-card-h hover-card" data-bs-toggle="tooltip" data-bs-placement="right"
            data-bs-custom-class="tooltip-{{ $ResearchPublicationssdeanHotIndicators['color'] ?? 0 }}"
            data-bs-original-title="{{ $ResearchPublicationsPercentage['description'] ?? 0 }}">
            <div class="card-body d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <div
                  class="badge bg-label-{{ $ResearchPublicationssdeanHotIndicators['color'] ?? 0 }} rounded p-1_5 me-4"><i
              ...
              <div class="d-flex flex-grow-1 align-items-center">
                <div class="progress w-100 me-4" style="height:8px;">
                  <div class="progress-bar bg-{{ $ResearchPublicationssdeanHotIndicators['color'] ?? 0 }}"
                    role="progressbar" style="width:{{ $ResearchPublicationssdeanHotIndicators['avg'] ?? 0 }}%"
                    aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span class="text-body-secondary">{{ $ResearchPublicationssdeanHotIndicators['avg'] ?? 0 }}%</span>
                <span
                  class="badge bg-label-{{ $ResearchPublicationssdeanHotIndicators['color'] ?? 0 }} ms-1">{{ $ResearchPublicationssdeanHotIndicators['rating'] ?? 0 }}</span>
              </div>
            </div>
          </div>
          ...
          @php
            ...
            $AdmissionTargetPercentage = getRatingByPercentage($AdmissionTargetsdeanHotIndicators['avg'] ?? 0);
           @endphp
          <div class="card mb-6 scgrool-card-h hover-card" data-bs-toggle="tooltip" data-bs-placement="right"
            data-bs-custom-class="tooltip-{{ $AdmissionTargetsdeanHotIndicators['color'] ?? 0 }}"
            data-bs-original-title="{{ $AdmissionTargetPercentage['description'] ?? 0 }}">
            <div class="card-body d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <div class="badge bg-label-{{ $AdmissionTargetsdeanHotIndicators['color'] ?? 0 }} rounded p-1_5 me-4"><i
                    class="icon-base ti tabler-mood-smile icon-md"></i>
                </div>
                <div>
              ...
              <div class="d-flex flex-grow-1 align-items-center">
                <div class="progress w-100 me-4" style="height:8px;">
                  <div class="progress-bar bg-{{ $AdmissionTargetsdeanHotIndicators['color'] ?? 0 }}" role="progressbar"
                    style="width:{{ $AdmissionTargetsdeanHotIndicators['avg'] ?? 0 }}%" aria-valuenow="65"
                    aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span class="text-body-secondary">{{ $AdmissionTargetsdeanHotIndicators['avg'] ?? 0 }}%</span>
                <span
                  class="badge bg-label-{{ $AdmissionTargetsdeanHotIndicators['color'] ?? 0 }} ms-1">{{ $AdmissionTargetsdeanHotIndicators['rating'] ?? 0 }}</span>
              </div>
            </div>
          </div>
