                  ...
                  <ul class="p-0 m-0">
                    <li class="d-flex mb-6">
                      ...
                      <div class="row w-100 align-items-center">
                        <div class="col-9">
                          <div class="me-2">
                            <h6 class="mb-1_5">No achievement of Research Publications target (Scopus Indexed)</h6>
                          </div>
                        </div>
                     ...
                     <li class="d-flex mb-6">
                      ...
                      <div class="row w-100 align-items-center">
                        <div class="col-9">
                          <div class="me-2">
                            <h6 class="mb-1_5">No of Grants submitted and won</h6>
                          </div>
                        </div>
                        <div class="col-3 text-end">
                          <button type="button" class="btn btn-sm btn-icon btn-label-secondary" role="button"
                    ...
                    <li class="d-flex mb-6">
                      ...
                      <div class="row w-100 align-items-center">
                        <div class="col-9">
                          <div class="me-2">
                            <h6 class="mb-1_5">No achievement of Multidisciplinary Projects targets / Products delivered to Industry</h6>
                          </div>
                        </div>
                        <div class="col-3 text-end">
                          <button type="button" class="btn btn-sm btn-icon btn-label-secondary" role="button"
                    ...
                    <li class="d-flex mb-6">
                      ...
                      <div class="row w-100 align-items-center">
                        <div class="col-9">
                          <div class="me-2">
                            <h6 class="mb-1_5">Intellectual Properties</h6>
                          </div>
                        </div>
                        <div class="col-3 text-end">
                          <button type="button" class="btn btn-sm btn-icon btn-label-secondary" role="button"
                    ...
                    <li class="d-flex mb-6">
                      ...
                      <div class="row w-100 align-items-center">
                        <div class="col-9">
                          <div class="me-2">
                            <h6 class="mb-1_5">Rating on Impact of Research Conferences Organized</h6>
                          </div>
                        </div>
                        <div class="col-3 text-end">
                          <button type="button" class="btn btn-sm btn-icon btn-label-secondary" role="button"
                    ...
                    <li class="d-flex mb-6">
                      ...
                      <div class="row w-100 align-items-center">
                        <div class="col-9">
                          <div class="me-2">
                            <h6 class="mb-1_5">No Trainings, seminars & workshop conducted with Impact</h6>
                          </div>
                        </div>
                        <div class="col-3 text-end">
                          <button type="button" class="btn btn-sm btn-icon btn-label-secondary" role="button"
      ...
      <div class="row g-6">
        <div class="col-md">
          <div class="accordion mt-4" id="accordionExample">
            ...
            <div class="accordion-item" id="institutional-engagement">
              <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordionThree" aria-expanded="false" aria-controls="accordionThree">
                <i class="icon-base ti tabler-moon me-2"></i>Institutional Engagement</button>
              </h2>
             ...
             <div class="accordion-item" id="institutional-engagement-operational">
                <h2 class="accordion-header" id="headingfour">
                  ...
                  <i class="icon-base ti tabler-library-minus me-2"></i>
                  Institutional-Engagement-Operational</button>
                </h2>
         ...
         <ul class="list-unstyled mb-0">
             ...
             <li class="mb-4 d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <div class="badge bg-label-secondary text-body p-2 me-4 rounded"><i class="icon-base ti tabler-list-check icon-md"></i></div>
                <div>
                  <h6 class="mb-0">Computer Science</h6>
                </div>
              </div>
             ...
             <li class="mb-4 d-flex">
              ...
              <div class="d-flex flex-grow-1 align-items-center">
                <div class="progress w-100 me-4" style="height:8px;">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 3%" aria-valuenow="86" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                          ...
                          <div class="card-body">
                            <div class="d-flex align-items-center mb-2">
                              <div class="avatar me-4">
                                <span class="avatar-initial rounded bg-label-primary"><i class="icon-base ti tabler-git-fork icon-28px"></i></span>
                              </div>
                              <h4 class="mb-0">8%</h4>
                            </div>
                      ...
                      <div class="col-lg-3 col-sm-6">
                        <div class="card card-border-shadow-warning h-100" role="button"
                          ...
                          <div class="card-body">
                            <div class="d-flex align-items-center mb-2">
                              <div class="avatar me-4">
                                <span class="avatar-initial rounded bg-label-warning"><i class="icon-base ti tabler-load-balancer icon-28px"></i></span>
                              </div>
                              <h4 class="mb-0">8%</h4>
                            </div>
                      ...
                      <div class="col-lg-3 col-sm-6">
                        <div class="card card-border-shadow-danger h-100">
                          <div class="card-body">
                            <div class="d-flex align-items-center mb-2">
                              <div class="avatar me-4">
                                <span class="avatar-initial rounded bg-label-danger"><i class="icon-base ti tabler-adjustments icon-28px"></i></span>
                              </div>
                              <h4 class="mb-0">27%</h4>
                            </div>
                      ...
                      <div class="col-lg-3 col-sm-6">
                        <div class="card card-border-shadow-primary h-100" role="button"
                          ...
                          <div class="card-body">
                            <div class="d-flex align-items-center mb-2">
                              <div class="avatar me-4">
                                <span class="avatar-initial rounded bg-label-primary"><i class="icon-base ti tabler-brand-asana icon-28px"></i></span>
                              </div>
                              <h4 class="mb-0">8%</h4>
                            </div>
                      ...
                      <div class="col-lg-3 col-sm-6">
                        <div class="card card-border-shadow-danger h-100">
                          <div class="card-body">
                            <div class="d-flex align-items-center mb-2">
                              <div class="avatar me-4">
                                <span class="avatar-initial rounded bg-label-danger"><i class="icon-base ti tabler-feather icon-28px"></i></span>
                              </div>
                              <h4 class="mb-0">27%</h4>
                            </div>
