                        ...
                        <div class="tab-pane fade show active" id="form1" role="tabpanel">
                            ...
                            <form id="editForm" enctype="multipart/form-data" class="row">
                                ...
                                <input type="hidden" name="record_id" value="{{ $data->id }}">
                                 <input class="d-none" type="radio" name="compliance_and_usage_of_lms" id="good" value="1" checked>
                                                ...
                                                <h6 class=" d-block">Course folder status</h6>
                                                    <div class="form-check mt-4">
                                                        <input class="form-check-input" type="checkbox" name="completion_status[]" id="module"
                                                            value="Module" {{ in_array('Module', $completionStatus) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check mt-4">
                                                      ...
                                                      <div class="form-check mt-4">
                                                        <input class="form-check-input" type="checkbox" name="completion_status[]" id="cqi_docuement"
                                                            value="CQI Docuement" {{ in_array('CQI Docuement', $completionStatus) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="completion_status[]" id="good" value="Good" {{ in_array('Good', $completionStatus) ? 'checked' : '' }}>
                                                            <label  for="good">Good</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="completion_status[]" id="bad" value="Bad" {{ in_array('Bad', $completionStatus) ? 'checked' : '' }}>
                                                            <label  for="bad">Bad</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="completion_status[]" id="any" value="Any" {{ in_array('Any', $completionStatus) ? 'checked' : '' }}>
                                                     ...
                                                     <div class="mt-4">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="completion_status[]" id="grading_sheet" value="Grading Sheet" {{ in_array('Grading Sheet', $completionStatus) ? 'checked' : '' }}>
                                                            <label for="grading_sheet">Grading Sheet</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="completion_status[]" id="marks_Sheet" value="Marks Sheet" {{ in_array('Marks Sheet', $completionStatus) ? 'checked' : '' }}>
                                                            <label for="marks_Sheet">Marks Sheet</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" name="completion_status[]" id="clo_plo_maping_Sheet" value="CLO PLO Maping Sheet" {{ in_array('CLO PLO Maping Sheet', $completionStatus) ? 'checked' : '' }}>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#editForm').submit(function (e) {
                ...
                $.ajax({
                    url: "{{ route('compliance-usage-of-lms.update', $data->id) }}",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function (res) {
                        Swal.fire('Success', res.message, 'success')
                            .then(() => {
                                window.location.href = "{{ route('compliance-usage-of-lms.index') }}";
                            });
                    },
                     error: function (xhr) {
                            Swal.close();
