                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="radio" name="compliance_and_usage_of_lms" id="lms_not_completed"
                                                value="25" {{ $data->compliance_and_usage_of_lms == 25 ? 'checked' : '' }}>
