        ...
        @if(in_array(getRoleName(activeRole()), ['DOPS']))
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="{{ url('kpa/2/category/6/indicator/132') }}" class="btn btn-success">Add</a>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="commericaGainFormModalLabel">Edit Scholar's Satisfaction (In Thesis
                                Stage)</h5>
