                                ...
                                <table id="achievementTable" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Alumni Engagement Rate</th>
                                            <th>Portal Registration Rate</th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
                                    ...
                                    <div id="student-satisfaction-container">
                                        <div class="student-group row g-3 mb-3 border p-3 mt-3 rounded">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon11">%</span>
                                                    <input type="number" class="form-control" id="alumni_engagement_rate"
                                                        name="alumni_engagement_rate" required
                                                        placeholder="Alumni Engagement Rate">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="portal_registration"
                                                        ...
                                                        placeholder="Portal Registration
                                                                                                                                                                            Rate">
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
                    ...
                    success: function (data) {
                        ...
                        const rowData = forms.map((form, i) => {
                            ...
                            return [
                                ...
                                form.department.name || 'N/A',
                                form.program.program_name || 'N/A',
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.edit-form-btn', function () {
                    ...
                    $f.find('[name="alumni_engagement_rate"]').val(form.alumni_engagement_rate);
                    $f.find('[name="portal_registration"]').val(form.portal_registration);
