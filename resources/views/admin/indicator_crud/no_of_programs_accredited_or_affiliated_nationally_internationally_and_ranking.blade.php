    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="">
                    <a href="{{ url('kpa/6/category/14/indicator/154') }}" class="btn btn-primary">Add</a>
                </div>
            </div>
        ...
        <div class="modal fade" id="multidisciplinaryProjectFormModal" tabindex="-1"
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="commericaGainFormModalLabel">Edit No of Programs accredited or
                            affiliated nationally/ Internationally and ranking</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <select name="program_level" id="program_level"
                            ...
                            <option value="PG">PG</option>
                                ...
                                <div class="col-md-6 d-none" id="other_cpd_box">
                                    ...
                                    <input type="text" name="accrediting_other_detail" id="accrediting_other_detail"
                                        class="form-control" placeholder="Enter other detail">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Affiliated Body Name</label>
                                    <input type="text" name="affiliated_body_name" id="affiliated_body_name"
                                        class="form-control" placeholder="Affiliated Body Name">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Affiliated for</label>
                                    <input type="text" name="affiliated_for" id="affiliated_for" class="form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="ranking_position" id="ranking_position" class="form-control"
