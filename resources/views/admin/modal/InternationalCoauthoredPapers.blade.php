...
<!--  Payment Methods modal -->
    ...
    <div class="modal fade" id="InternationalCoauthoredPapers" tabindex="-1" aria-hidden="true">
                                ...
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                            @php
                                                ...
                                                $avg = $data['department_international_fraction'];
                                                 if ($avg >= 90) {
                                                            $color = 'primary';
                                                            $rating = 'OS';
                                                        } elseif ($avg >= 80) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="badge bg-{{ $color }}">
                                                                {{number_format($data['department_international_fraction']) }}%
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="badge bg-{{ $color }}">
                                    ...
                                    <tfoot>
                                        <tr class="table-primary">
                                            ...
                                            <th>
                                                <b>
                                                    {{number_format($data['department_international_fraction'], 1) }}
                                                </b>
                                            </th>
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                            @php
                                                $data=ResearchInnovationAndCommercialization(Auth::user()->employee_id, $activeRoleId, 2, 5, 127);
