                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                            @php
                                                $data=calculateLineManagerFeedbackAverage(Auth::user(), $activeRoleId, 165);
                                                $avg = $data['department_average'];
                                                 if ($avg >= 90) {
                                                            $color = 'primary';
                                                            $rating = 'OS';
                                                        } elseif ($avg >= 80) {
                                            ...
                                            @endphp
                                                @if(!empty($data))
                                                    <tr>
                                                        <td>1</td>
                                                        <td>{{ $data['department_average'] }}</td>
                                                        <td>{{ $data['department_average'] }}</td>
                                                        <td>
                                                            <div class="badge bg-{{ $color }}">
                                                                {{number_format($data['department_average']) }}%
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="badge bg-{{ $color }}">
                                    ...
                                    <tfoot>
                                        <tr class="table-primary">
                                            ...
                                            <th>
                                                <b>
                                                    {{number_format($data['department_average'], 1) }}
                                                </b>
                                            </th>
