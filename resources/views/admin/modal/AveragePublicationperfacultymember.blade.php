...
<!--  Payment Methods modal -->
    ...
    <div class="modal fade" id="AveragePublicationperfacultymember" tabindex="-1" aria-hidden="true">
                                            ...
                                            @endphp
                                                @if(!empty($data))
                                                    <tr>
                                                        ...
                                                        <td>{{ number_format($data['weighted_score'], 1) }}</td>
                                                        <td>
