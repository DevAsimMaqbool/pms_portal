...
@if(in_array(getRoleName(activeRole()), ['HOD']))
    <div class="modal fade" id="PLsandFacultySatisfactionScore" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content custom-modal">
                ...
                <div class="modal-body p-4">
                    ...
                    <h3 class="text-center mb-4 fw-bold text-primary">
                        PLs and Faculty Satisfaction Score
                    </h3>
                    <div class="card">
                ...
                <div class="modal-body p-4">
                    ...
                    <h3 class="text-center mb-4 fw-bold text-primary">
                        <div class="badge bg-label-primary rounded p-2"><i
                                class="icon-base ti tabler-clock-hour-2 icon-md"></i></div>PLs and Faculty Satisfaction Score
                    </h3>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                            @php
                                                $data=ResearchInnovationAndCommercialization(Auth::user()->employee_id, $activeRoleId, 7, 16, 178);
