...
<div class="modal fade" id="PatentsIntellectualPropertyIPR" tabindex="-1" aria-hidden="true">
    ...
    $sumPatentsIntellectualProperty = 0;
                                ...
                                <tbody>
                                        ...
                                        @php
    $data = PatentsIntellectualProperty(Auth::user()->employee_id, $activeRoleId, 138,$currentYear->id);
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                            @php
                                                $data=ResearchInnovationAndCommercializationYear(Auth::user()->employee_id, $activeRoleId, 2, 8, 138,$currentYear->id);
