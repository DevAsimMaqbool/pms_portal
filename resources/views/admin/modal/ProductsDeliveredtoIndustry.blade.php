                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table"">
                                    ...
                                    <tbody>
                                        @php
                                            $ProductsDeliveredToIndustry = ProductsDeliveredToIndustry(Auth::user()->employee_id, $activeRoleId, 199,$currentYear->id);
                ...
                <div class="modal-body text-center p-4">
                    ...
                    <h3 class="text-center mb-4 fw-bold text-primary">
                        <div class="badge bg-label-primary rounded p-2"><i
                                class="icon-base ti tabler-clock-hour-2 icon-md"></i></div>Products Delivered to Industry
                    </h3>
                    <button type="button" class="mb-3 btn rounded-pill btn-primary waves-effect waves-light">{{ $currentYear->year }}</button>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                        @php
                                            $data = departmentTargetIndicatorsAnalysisOfHOD(Auth::user()->employee_id, $activeRoleId, 2, 8, 199,$currentYear->id);
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                        @php
                                            $data = ResearchInnovationAndCommercializationYear(Auth::user()->employee_id, $activeRoleId, 2, 8, 199,$currentYear->id);
