                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                        @php
                                            $data = retentionRateofFaculty(Auth::user()->employee_id, $activeRoleId, 6, 15, 162,$currentYear->id);
                                        @endphp
                                ...
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                        @php
                                            ...
                                            $data=ResearchInnovationAndCommercializationYear(Auth::user()->employee_id, $activeRoleId, 6, 15, 162,$currentYear->id);
