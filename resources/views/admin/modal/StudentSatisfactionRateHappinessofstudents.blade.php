                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                ...
                                @php
                                    $data = StudentSatisfactionRateForHOD($activeRoleId, 123,$currentYear->id);
                                    $overallAvg = collect($data)->avg('avg_employer_satisfaction');
                                @endphp
                                ...
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                        @php
                                            ...
                                            $data = ResearchInnovationAndCommercializationYear(Auth::user()->employee_id, $activeRoleId, 1, 4, 124);
