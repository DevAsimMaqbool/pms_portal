                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                        @if(in_array(getRoleName(activeRole()), ['Assistant Professor', 'Associate Professor', 'Professor']))
                                            @php
                                                $data = RatingonImpact(Auth::id(), $activeRoleId,$currentYear->id);
                                            @endphp
                                            @if($data['target'] > 0)
                                                <tr>
                                                    <td>1</td>
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                            @php
                                                $data=departmentTargetIndicatorsAnalysisOfHOD(Auth::user()->employee_id, $activeRoleId, 2, 9, 140,$currentYear->id);
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped align-middle custom-table">
                                    ...
                                    <tbody>
                                            @php
                                                $data=ResearchInnovationAndCommercializationYear(Auth::user()->employee_id, $activeRoleId, 2, 9, 140,$currentYear->id);
