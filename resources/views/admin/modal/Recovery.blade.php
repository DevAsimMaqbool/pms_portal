                ...
                <div class="modal-body p-4">
                    ...
                    <div class="nav-align-top nav-tabs-shadow">
                            ...
                            <ul class="nav custom-tabs" role="tablist">
                                <li class="nav-item">
                                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                        data-bs-target="#Recovery-spring" aria-controls="Recovery-spring"
                                        aria-selected="true">
                                        🌸 Yearly
                                    </button>
                                </li>
                        ...
                        <div class="tab-content">
                            <!-- Spring -->
                            <div class="tab-pane fade show active" id="Recovery-spring" role="tabpanel">
                                        ...
                                        <tfoot>
                                            <tr class="table-primary">
                                                ...
                                                <th class="fs-6"><span class="badge"
                                                        style="background-color: {{ $meta_avg_percentage->color }}">{{number_format($avg_percentage, 1) }}</span>
                                                </th>
                                                {{-- <th class="">W: {{number_format($data['weighted_score'], 1) }}</th>
                                                --}}
                                                <th class="fs-6 text-white">
                                                    <span class="badge"
                                                        style="background-color: {{ $meta_avg_percentage->color }}">
