                    ...
                    <tbody>
                        @foreach($submissions as $submission)
                            <tr>
                                ...
                                <td>
                                    <strong>{{ $submission->display_award }}</strong>

                                    @if(!empty($submission->display_award_values))
                                        <div class="mt-2">
                                            @foreach($submission->display_award_values as $award)
                                                <div class="mb-1">
