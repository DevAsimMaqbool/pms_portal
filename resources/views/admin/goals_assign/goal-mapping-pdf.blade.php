                    ...
                    @foreach($details as $detail)
                        ...
                        @forelse($detail->indicators as $assignmentIndicator)
                                    ...
                                    <tr>
                                        ...
                                        {{-- TARGET --}}
                                        <td>{{ $detail->dimension_target }}</td>

                                        {{-- ACHIEVED --}}
                                        <td>{{ optional($detail->userDetails->first())->target_achieved ?? '-' }}</td>

                                        {{-- REMAINING --}}
                                        <td>
                                            {{
                                                (float) $detail->dimension_target -
                                                (float) (optional($detail->userDetails->first())->target_achieved ?? 0)
                                                        }}
                            </td>
