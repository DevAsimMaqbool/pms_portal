...
@section('content')
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row gy-6">
      ...
      <!-- Sales Overview -->
      <div class="{{ getRoleIdByName(activeRole()) == 33 ? 'col-lg-4' : 'col-lg-3' }} col-md-12 d-flex flex-column">
          ...
          <div class="col-lg-4 col-md-3 col-sm-6">
            <div class="card h-100" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-"
              ...
              <div class="card-body d-flex justify-content-center align-items-center ">
                <h6 class="mb-0 text-center text-white">As {{ substr(ucfirst(Auth::user()->job_title), 0, 7) }}
                  <h6>
              </div>
            </div>
          </div>
      ...
      @else
        @foreach($result as $kpakey => $kpa)
          ...
          <div class="{{ getRoleIdByName(activeRole()) == 33 ? 'col-lg-4' : 'col-lg-3' }} col-md-4" id="{{ $targetId }}">
            <a href="{{ route('kpa.report', ['id' => $kpa['id']]) }}" class="text-decoration-none">
              <div class="flip-card h-100">
                <div class="flip-card-inner">
    ...
    <div class="row gy-6 mt-2">
      ...
      <div class="col-md-6 col-lg-4">
        ...
        <div class="scrollableCol" style="height:409px; overflow:auto; scrollbar-width: none;">
          ...
          @endphp
          @if(getRoleIdByName(activeRole()) != 33)
            <div class="card mb-6 scgrool-card-h hover-card" data-bs-toggle="tooltip" data-bs-placement="right"
      ...
      @endif
      <div class="{{ getRoleIdByName(activeRole()) == 33 ? 'col-lg-6' : 'col-lg-4 col-sm-6' }}">
        <div class=" card h-100">
          <div class="card-header d-flex align-items-center justify-content-between">
            <div class="card-title mb-0">
...
@push('script')
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const dataset1 = @json(forVirtueReport(null, auth::user()->id));
      const dataset2 = @json(forVirtueReport(auth::user()->id));
      const dataset3 = @json(getStudentFeedbackByBarcode(auth::user()->barcode));
