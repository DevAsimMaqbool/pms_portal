                    ...
                    <div class="modal-body">
                        ...
                        <form id="indicatorCategoryForm" class="row">
                            ...
                            <div class="col-12 form-control-validation mb-4">
                                ...
                                <select id="key-performance-area" class="select2 form-select" data-allow-clear="true"
                                    name="key_performance_area" required>
                                </select>
                            ...
                            <div class="col-12 form-control-validation mb-4">
                                ...
                                <select id="indicator-category" class="select2 form-select" data-allow-clear="true"
                                    name="indicator_category" required>
                                </select>
    ...
    <script>
        ...
        function editIndicatorCategory11(id) {
            ...
            $.get(`/indicator/${id}/edit`, function (data) {
                ...
                $('#modalTitle').text('Edit Indicator');
                $('#nameError').text('');
                modal.show();
            });
        }
