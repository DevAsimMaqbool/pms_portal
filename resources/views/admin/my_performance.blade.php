                ...
                <div class="row flex-fill">
                        ...
                        <div class="card" style="box-shadow: none;background: none;">
                            <div class="card-header text-center">
                                <div class="card-title mb-0">
                                    ...
                                    <div class="mb-2 rounded bg-label-success p-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-custom-class="tooltip-success"
                                        data-bs-original-title="{{ Auth::user()->department }}">
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-6">
                        <div class="card h-100">
                            <div class="card-body d-flex justify-content-center align-items-center">
                                <h4 class="mb-0 text-center">91%</h4>
                            </div>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-3 col-sm-6">
                        <div class="card bg-primary h-100" data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-custom-class="tooltip-primary"
                            data-bs-original-title="You’re going beyond what’s asked of you.">
                            <div class="card-body d-flex justify-content-center align-items-center">
                                <h4 class="mb-0 text-center text-white">OS</h4>
                            </div>
                        </div>
                    </div>
                    <!--/ Expenses -->
