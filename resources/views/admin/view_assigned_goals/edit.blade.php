        ...
        <div class="card shadow border-0">
            ...
            <div class="card-body">
                ...
                <form id="mappingForm">
                    ...
                    <input type="hidden" name="goal_assignment_id" value="{{ $assignment->id }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="kpa_id" name="kpa_id" class="form-select" disabled>
                            <option value="">Select KPA</option>
                            @foreach($kpas as $kpa)
                                <option value="{{ $kpa->id }}" {{ $assignment->kpa_id == $kpa->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select class="select2 form-select kpi_id" name="kpi_id" id="kpi_id" disabled>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="goalSelector" class="form-select" name="goal_id[]" multiple disabled>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="saveEmployees">
                            Done
                        </button>
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            let allVerified = assignment.details.every(function (detail) {
                return detail.user_details &&
                    detail.user_details.length > 0 &&
                    detail.user_details[0].status === 'Completed';
            });
                    ...
                    goal.objectives.forEach(function (obj) {
                        ...
                        obj.dimensions.forEach(function (dim) {
                            ...
                            if (detail) {
                                ...
                                if (detail.user_details) {
                                    achieved = detail.user_details[0].target_achieved ?? '';
                                    status = detail.user_details[0].status ?? '';
                                }
                            ...
                            html += `
                                                                                    ...
                                                                                    <input
                                                                                    type="hidden"
                                                                                    name="progress[${detail.id}][detail_id]"
                                                                                    value="${detail.id}">
                                                                                    <input
                                                                                    type="number"
                                                                                    class="form-control weight"
                                                                                    value="${achieved}"
                                                                                    name="progress[${detail.id}][target_achieved]">
            ...
            $('#mappingForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('view-assign-goals.update', $assignment->id) }}",
                    ...
                    success: function (response) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = "{{ route('view-assign-goals.index') }}";
