...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <form method="POST"
            action="{{ route('goal-self-reports.store') }}" enctype="multipart/form-data">
    ...
    <div class="section-header">
        ...
        <div class="section-title">
            ...
            <div>
                ...
                <small>
                    Provide supporting evidence for your reported progress, if applicable.
                </small>
        ...
        <div class="form-group">
            ...
            @else
                ...
                <small class="form-hint">
                    ...
                    Add supporting evidence for your reported progress, if applicable.
