            ...
            <div class="card-datatable table-responsive card-body">
                ...
                <form id="researchForm" enctype="multipart/form-data" class="row">
                    ...
                    <div class="row g-6">
                        ...
                        <div class="col-md-6">
                            <label for="no_of_ip_filled" class="form-label">No of IP filled</label>
                            <input type="text" id="no_of_ip_filled" name="no_of_ip_filled" class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label for="name_of_ip_filled" class="form-label">Name of IP filled</label>
                            <input type="text" id="name_of_ip_filled" name="name_of_ip_filled" class="form-control">
                        </div>
