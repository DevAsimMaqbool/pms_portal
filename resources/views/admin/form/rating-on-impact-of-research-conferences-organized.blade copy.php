        ...
        <div class="card-datatable table-responsive card-body">
            ...
            <form id="researchForm" enctype="multipart/form-data" class="row">
                ...
                <div class="row g-6">
                    ...
                    <div class="col-md-6">
                        <label for="event_proposal_form_submission" class="form-label">Event proposal form
                            submission</label>
                        <input type="text" id="event_proposal_form_submission" name="event_proposal_form_submission"
                            class="form-control">
                    </div>

                    <div class="col-md-6">
                        <label for="scopus_indexed_confirmation" class="form-label">Scopus indexed confirmation attach
                            proof</label>
                        <input type="file" id="scopus_indexed_confirmation" name="scopus_indexed_confirmation"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Conference Target</th>
                            <td id="modalconferenceTarget"></td>
                        </tr>
                        <tr>
                            <th>Event Proposal Form Submission</th>
                            <td id="modalEventProposal"></td>
                        </tr>
                        <tr>
                            <th>Status</th>
                            <td>
