                                    ...
                                    <div class="col-12 col-lg-12">
                                        ...
                                        <div class="card mb-6">
                                            <div class="card-header">
                                                <h5 class="card-title mb-0">Alumni Satisfaction Rate</h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                ...
                <form id="importForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Import Alumni Satisfaction Rate Data</h5>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#researchForm').on('submit', function (e) {
                    ...
                    $.ajax({
                        url: "{{ route('alumni-satisfaction-rate.store') }}",
                        type: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
