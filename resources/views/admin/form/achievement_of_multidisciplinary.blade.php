        ...
        <div class="card">
            <div class="card-datatable table-responsive card-body">
                ...
                <form id="researchForm" enctype="multipart/form-data" class="row">
                    ...
                    <div class="row g-6">
                        <div class="col-md-6">
                            <label for="name_of_project_initiated" class="form-label">Name of project initiated during the
                                quarter</label>
                            <input type="text" id="name_of_project_initiated" name="name_of_project_initiated"
                                class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label for="other_disciplines_engaged" class="form-label">Other disciplines engaged</label>
                            <input type="text" id="other_disciplines_engaged" name="other_disciplines_engaged"
                                class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="identified_public_sector_entity" class="form-label">Identified public sector
                                entity</label>
                            <input type="text" id="identified_public_sector_entity" name="identified_public_sector_entity"
                                class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                ...
                                <input type="radio" name="third_party_validation" id="third_party_validation_no" value="no"
                                    checked>
