...
<select name="subject_id" id="subject_id" class="select2 form-select faculty-member" required>
...
<select name="ranking_body" id="ranking_body" class="select2 form-select">
...
<input type="number" name="targeted_ranking_range" id="targeted_ranking_range" class="form-control" required>
</div>

<div class="col-md-6">
<label for="actual_ranking_achieved" class="form-label">Actual Ranking Achieved</label>
<select name="actual_ranking_achieved" id="actual_ranking_achieved" class="select2 form-select faculty-member" required>
<option value="">-- Select Subject--</option>
...
<select name="ranking_status" id="ranking_status" class="select2 form-select faculty-member" required>
<option value="">-- Select Subject--</option>
...
<div>
<input class="form-control" name="evidence_upload" id="evidence_upload" type="file" id="formFile">
</div>
</div>
<div class="col-md-12">
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#researchForm').on('submit', function (e) {
                    ...
                    $.ajax({
                        url: "{{ route('subject-ranking-target.store') }}",
                        type: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
