            ...
            <div class="card-datatable table-responsive card-body">
                @if(auth()->user()->hasRole(['HOD']))
                    ...
                    <ul class="nav nav-tabs mb-3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#form1" role="tab"># Trainings, seminars &
                        ...
                        <div class="tab-pane fade show active" id="form1" role="tabpanel">
                            <form id="researchForm" enctype="multipart/form-data" class="row">
                                ...
                                <div class="row g-6">
                                    ...
                                    <div class="col-md-6">
                                        <label for="target_of_ken_knowledge_products" class="form-label">Target of KEN Knowledge
                                            products</label>
                                        <input type="text" id="target_of_ken_knowledge_products"
                                            name="target_of_ken_knowledge_products" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label for="event_proposal_forms_submission" class="form-label">Event proposal forms
                                            submission</label>
                                        <input type="text" id="event_proposal_forms_submission"
                                            name="event_proposal_forms_submission" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label for="no_of_knowledge_products_produced" class="form-label">No of knowledge
                                            products produced</label>
                                        <input type="text" id="no_of_knowledge_products_produced"
                                            name="no_of_knowledge_products_produced" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label for="no_of_participants" class="form-label">No of participants</label>
                                        <input type="text" id="no_of_participants" name="no_of_participants"
                                            class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label for="no_of_participants_from_the_industry" class="form-label">No of participants
                                            from the industry</label>
                                        <input type="text" id="no_of_participants_from_the_industry"
                                            name="no_of_participants_from_the_industry" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label for="no_of_participants_from_the_public_sector" class="form-label">No of
                                            participants from the public sector</label>
                                        <input type="text" id="no_of_participants_from_the_public_sector"
                                            name="no_of_participants_from_the_public_sector" class="form-control">
                                    </div>


                                </div>
                                <div class="col-4 text-center demo-vertical-spacing" style="margin-left: -153px;">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Co-Author</th>
                                <td id="modalCoAuthers"></td>
                            </tr>
                            <tr>
                                <th>Author Rank</th>
                                <td id="modalAuthorRank"></td>
                            </tr>
                            <tr>
                                <th>Status</th>
                                <td>
