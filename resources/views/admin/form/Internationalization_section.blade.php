                        ...
                        <div class="card mb-6">
                            <div class="row row-bordered g-0">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="stakeholder_category[]" value="faculty" {{ in_array('faculty', $chaudhry) ? 'checked' : '' }}>
                                                    <label>Faculty</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="stakeholder_category[]" value="staff" {{ in_array('staff', $chaudhry) ? 'checked' : '' }}>
                                                    <label>Staff</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="stakeholder_category[]" value="students" {{ in_array('students', $chaudhry) ? 'checked' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="nature_of_activity[]" value="social_responsibility" {{ in_array('social_responsibility', $chaudhry) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="nature_of_activity[]" value="sustainability" {{ in_array('sustainability', $chaudhry) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="nature_of_activity[]" value="both" {{ in_array('both', $chaudhry) ? 'checked' : '' }}>
                                                    <label>Both</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="activity_location[]" value="within_campus" {{ in_array('within_campus', $chaudhry) ? 'checked' : '' }}>
                                                    <label>Within Campus</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="activity_location[]" value="outside_campus"
                                                        {{ in_array('outside_campus', $chaudhry) ? 'checked' : '' }}>
                                                    <label>Outside Campus</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input sitara-checkbox"
                                                        name="activity_location[]" value="both" {{ in_array('both', $chaudhry) ? 'checked' : '' }}>
                                                    <label>Both</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card-body">
                                        <textarea class="form-control description-area" id="SitaraeQiyadat" name="sitara_qiyadat_why" rows="4"
                                            placeholder="Short answer">{{ $submission->sitara_qiyadat_why ?? '' }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card-body">
                                        <textarea class="form-control description-area" id="SitaraeQiyadat"
                                            name="sitara_qiyadat_why" rows="4"
                                            placeholder="Short answer">{{ $submission->sitara_qiyadat_why ?? '' }}</textarea>
                                    </div>
                                </div>
