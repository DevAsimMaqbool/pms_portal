                        ...
                        for ($year = $currentYear - 2; $year <= $currentYear + 3; $year++) {
                            ...
                            echo "<option value='Fall $year'>Fall $year</option>";
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <select name="sector" class="select2 form-select faculty-member"
                                                                        required>
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="market_competitive_salary" class="form-label">Market
                                                                        Competitive
                                                                        Salary</label>
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <div>
                                                                        <input type="radio" name="job_relevancy" id="job_relevancy"
                                                                            value="yes">
