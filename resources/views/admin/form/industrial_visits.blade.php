...
<div class="app-ecommerce">
    ...
    <div class="nav-align-top">
        ...
        <ul class="nav nav-pills mb-4" role="tablist">
            <li class="nav-item">
                <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-top-home" aria-controls="navs-pills-top-home" aria-selected="true">Industrial Visits</button>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content" style="padding:0;background: none;border: none;box-shadow: none;">
            ...
            <div class="d-flex align-content-center flex-wrap gap-4">
                ...
                <a class="btn btn-label-primary" href="{{ route('indicators_crud.index', ['slug' => 'industrial_visits', 'id' => $indicatorId]) }}">View</a></div>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="department_program" class="form-control" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Industry / Organization Visited</label>
                             <input type="text" name="industry_organization" class="form-control" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="purpose_learning_objective" class="form-control" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                           ...
                           <input type="number" name="students_involved" class="form-control" required>
                        </div>
                        <div class="col-md-6 mb-3">
