...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:Teacher|HOD|ORIC|Dean|Human Resources|Assistant Professor|Professor|International Office|QEC|Finance|OEC|Employability Center|Program Leader UG|Program Leader PG|DOPS')->group(function () {
