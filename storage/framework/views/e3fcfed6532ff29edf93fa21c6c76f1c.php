...
<script>
    ...
    function fetchIndicatorCategory() {
        $.ajax({
            url: "<?php echo e(route('indicator-category.index')); ?>",
            method: "GET",
            dataType: "json",
    ...
    function editComplaint(id) {
        ...
        $.get(`/indicator-category/${id}/edit`, function (data) {
            ...
            $('#key-performance-area').val(data.user.id);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/pms/resources/views/admin/indicator_category.blade.php ENDPATH**/ ?>