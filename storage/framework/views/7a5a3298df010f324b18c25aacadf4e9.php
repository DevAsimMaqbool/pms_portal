  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="<?php echo e(route('indicator-category.index')); ?>" class="menu-link">
        ...
        <div data-i18n="Stakeholder Submission Status">Indicator Category</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="#" class="menu-link">
...
<!-- / Menu --><?php /**PATH /Applications/MAMP/htdocs/pms/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>