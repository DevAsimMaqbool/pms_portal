...
class AchievementOfResearchPublicationsTarget extends Model
{
    ...
    protected $table = 'achievement_of_research_publications_target';
     ...
     protected $fillable = [
        'indicator_id','year_id','publication_title','journal_name','target_category','link_of_publications','journal_clasification', 'nationality',
        'scopus_q1','scopus_q2','scopus_q3','scopus_q4','journal_hec','journal_wos',
