...
class StudentsGlobalExperienceController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
         try {
            ...
            if(in_array(getRoleName(activeRole()), ['International Office'])) {
                ...
                if($status=="HOD"){
                    $forms = StudentsGlobalExperience::with(['faculty', 'department', 'program'])->where('created_by', $employee_id)
                        ->orderBy('id', 'desc')
                        ->get();
                }       
            }
        ...
        try { 
               ...
               $rules = [
                    ...
                    foreach ($request->student_enroll_1m as $student_enroll_1ms) {
                        ...
                        $savedRecords[] = StudentsGlobalExperience::create($student_enroll_1ms);
                    } 
    ...
    {
       $record = StudentsGlobalExperience::findOrFail($id);
