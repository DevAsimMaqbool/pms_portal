    ...
    public function boot(): void
    {
        ...
        Auth::viaRequest('web', function ($request) {
            if (Auth::check() && !Session::has('active_role')) {
                ...
                $teacherRoles = ['Teacher', 'Assistant Professor', 'Associate Professor', 'Professor', 'Program Leader UG', 'Program Leader PG', 'Finance', 'International Office', 'Human Resources', 'QCE', 'OEC', 'DOPS', 'Alumni Office', 'Employability Center', 'Rector', 'QCH', 'ORIC', 'Demonstrator'];
